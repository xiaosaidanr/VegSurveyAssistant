...
public class ClearableTextInputEditText extends TextInputEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init(){
        this.setPadding(this.getPaddingLeft(), this.getPaddingTop(), 24, this.getPaddingBottom());
